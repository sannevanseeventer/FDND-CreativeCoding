...
<div class="clouds">
  ...
  <div class="balloon">
    <div class="logo"> <img class="logo" src="/logo_spatwater2.png" alt="logo spatwater"/></div>
...
<style>
:root {
  --color-cloud: #ffffff86;
  --color-balloon: rgb(113, 176, 200);
  --color-balloon-2: #5d8da5;
...
.logo{
    background-image: url(./logo_spatwater2.png);
